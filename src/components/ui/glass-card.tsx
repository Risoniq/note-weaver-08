...
const GlassCard = React.forwardRef<HTMLDivElement, GlassCardProps>(({
  ...
  return <div ref={ref} className={cn("rounded-[20px] p-6 border border-white/50 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] transition-all duration-200 hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)]", variantStyles[variant], className)} {...props}>
